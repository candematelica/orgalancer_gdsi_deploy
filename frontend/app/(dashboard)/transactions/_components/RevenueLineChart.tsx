...
function buildChartData(transactions: Transaction[]): MonthData[] {
  const now = new Date();
  ...
  for (const tx of transactions) {
    ...
    if (key in monthMap) monthMap[key] += tx.amount;
  }
  ...
  return Object.entries(monthMap).map(([key, total]) => {
...
export default function RevenueLineChart({ transactions, currency }: Props) {
