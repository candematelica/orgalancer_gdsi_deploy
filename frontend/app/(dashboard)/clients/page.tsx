...
type DeleteModalState =
  | { type: "none" }
  | { type: "confirm"; client: Client }
  | { type: "warning"; client: Client };
...
export default function ClientsPage() {
  ...
  const handleDeleteClick = async (client: Client) => {
    try {
      ...
      setDeleteModal({ type: "confirm", client });
    }
  };
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-sm w-full mx-4">
            ...
            <p className="text-sm text-gray-500 mb-6">
              ...
              <span className="font-semibold text-gray-700">{deleteModal.client.name}</span>.
